...
- **EEA and UK consumers — right of withdrawal.** Your contract for Budgie Pro is with the **Apple App Store** or **Google Play** as seller, not with us. If you are a consumer in the EEA or the UK you have a statutory right to withdraw from a distance contract within **14 days**; that right is exercised through the store you purchased from, under its terms, and the store may treat your request as a refund request. Note that this right can be lost once you have expressly agreed to immediate access to digital content and acknowledged the loss of the withdrawal right. Nothing in these Terms limits any statutory right you have as a consumer.
...
Subscription purchases are validated and managed using **RevenueCat**; see our [Privacy Policy](./privacy.md) for how purchase data is handled.
...
## Advertising
The App may display advertisements, including those served through **Google AdMob**. Ad preferences can be managed through your device settings, the in‑app privacy options, or Google’s Ad Settings, as described in our [Privacy Policy](./privacy.md). Advertising is removed for **Budgie Pro** subscribers.
...
If you are a consumer resident in the EEA or the UK, this choice of law does not deprive you of the protection of the mandatory provisions of the law of the country in which you live, and you may bring proceedings in the courts of that country. If you have a complaint we have not resolved, please contact us first (see below); you may also be able to refer the matter to a consumer dispute body in your own country.
